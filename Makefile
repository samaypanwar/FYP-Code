...
connect: tmp.pem
	@ssh -i tmp.pem ubuntu@ec2-18-141-2-190.ap-southeast-1.compute.amazonaws.com

scp: tmp.pem
	@scp -i tmp.pem -r ubuntu@ec2-18-141-2-190.ap-southeast-1.compute.amazonaws.com:/home/ubuntu/FYP-Code/plotting .
...
.PHONY = train generate calibrate_synthetic calibrate_market connect get_py